...
Complete guide to authentication methods for MCP servers in coding assistant plugins.
...
coding assistant automatically handles the complete OAuth 2.0 flow for SSE and HTTP servers:

1. User attempts to use MCP tool
2. coding assistant detects authentication needed
3. Opens browser for OAuth consent
4. User authorizes in browser
5. Tokens stored securely by coding assistant
...
No additional auth configuration needed! coding assistant handles everything.
...
Tokens are stored securely by coding assistant:
...
**Token expiration:**
- coding assistant auto-refreshes
...
```json
{
  "api": {
    ...
    "headersHelper": "PLUGIN_ROOT/scripts/get-headers.sh"
  }
}
```
...
{
  "secure-api": {
    "command": "PLUGIN_ROOT/servers/mtls-wrapper",
...
```json
{
  "headersHelper": "PLUGIN_ROOT/scripts/generate-jwt.sh"
}
```
