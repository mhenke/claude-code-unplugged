...
- Current git status: (Retrieve by running `git status` with your bash tool)
- Current git diff (staged and unstaged changes): (Retrieve by running `git diff HEAD` with your bash tool)
...
- Current git diff (staged and unstaged changes): (Retrieve by running `git diff HEAD` with your bash tool)
- Current branch: (Retrieve by running `git branch --show-current` with your bash tool)
- Recent commits: (Retrieve by running `git log --oneline -10` with your bash tool)
